...
/*   Updated: 2022/02/09 17:37:04 by abonniss         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	const char	*error_msgs[] = {NULL, ERR_MSG_MAP_EMPTY, ERR_MSG_MALLOC,
		ERR_MSG_WRONG_EXTENSION, ERR_MSG_TOO_SMALL, ERR_MSG_NO_WALL,
		ERR_MSG_NOT_RECTANGLE, ERR_MSG_BAD_FD, ERR_MSG_WRG_COMP,
		ERR_MSG_TOO_MANY_PLAYER, ERR_MSG_TOO_MANY_EXIT, ERR_MSG_NO_COLLECTIBLE};
