...
/*   Updated: 2022/02/09 17:41:06 by abonniss         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	get_image_collec(t_game *game)
{
	game->img_collec = mlx_xpm_file_to_image(game->mlx_ptr,
			game->xpm_data_collec, &game->img_width, &game->img_height);
...
void	get_image_wall(t_game *game)
{
	game->img_wall = mlx_xpm_file_to_image(game->mlx_ptr,
			game->xpm_data_wall, &game->img_width, &game->img_height);
...
{
	game->img_ground = mlx_xpm_file_to_image(game->mlx_ptr,
			game->xpm_data_ground, &game->img_width, &game->img_height);
...
void	get_image_player(t_game *game)
{
	game->img_player = mlx_xpm_file_to_image(game->mlx_ptr,
			game->xpm_data_player, &game->img_width, &game->img_height);
...
{
	game->img_door = mlx_xpm_file_to_image(game->mlx_ptr,
			game->xpm_data_door, &game->img_width, &game->img_height);
